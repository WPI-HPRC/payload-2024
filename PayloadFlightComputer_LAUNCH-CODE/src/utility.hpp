...
//        };
    ...
    struct TelemPacket {
        ...
        void debugPrint() {
            ...
            Serial.print("rawMagY: "); Serial.print(magY); Serial.print(", ");
            Serial.print("rawMagZ: "); Serial.print(magZ); Serial.print(", ");
            ...
            Serial.print("targetGPSLat: "); Serial.println(targetGpsLat);
            Serial.print("targetGPSLong: "); Serial.println(targetGpsLong);

            Serial.print("desiredServoPos1: "); Serial.println(desiredServoPos1);
            Serial.print("actualServoPos1: "); Serial.println(actualServoPos1);

            Serial.print("desiredServoPos2: "); Serial.println(desiredServoPos2);
            Serial.print("actualServoPos2: "); Serial.println(actualServoPos2);

            Serial.print("desiredServoPos3: "); Serial.println(desiredServoPos3);
            Serial.print("actualServoPos3: "); Serial.println(actualServoPos3);

            Serial.print("desiredServoPos4: "); Serial.println(desiredServoPos4);
            Serial.print("actualServoPos4: "); Serial.println(actualServoPos4);

            Serial.print("trajA: "); Serial.println(trajA);
            Serial.print("trajB: "); Serial.println(trajB);
            Serial.print("trajC: "); Serial.println(trajC);
            Serial.print("trajD: "); Serial.println(trajD);
