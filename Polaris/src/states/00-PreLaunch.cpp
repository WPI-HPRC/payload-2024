...
void PreLaunch::loop_impl()
{
    ...
    // if (this->stateEstimator->initialized) //going to need to refactor this to be accel only 
    // {
        this->accelReadingBuffer[this->buffIdx++] = telemPacket.accelZ;
    ...
    // Intialize EKF
    // if (!this->stateEstimator->initialized) //again decide what to do with EKF 
    // {
